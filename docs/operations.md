...
`harbor-net-dns-gate` is centered on networking work in TypeScript. The technical target is: Design a TypeScript verification harness for dns systems, covering policy evaluation, deny and allow fixtures, and failure-oriented tests.
...
The score is deterministic. The current threshold is 159. Risk has a penalty of 5, latency has a penalty of 4, and weight contributes a bonus of 5.
