"""Regression checks for the harbor-net-dns-gate casebook."""
...
from casebook.harness import assert_expected, harbor_net_dns_gate_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(harbor_net_dns_gate_summary(), assert_expected())
